            ...
            , function (e)
              {
                  ...
                  if ($("#scanPlaceholder").attr("src") != "../images/file.png")
                  {
                      ...
                      var formData =
                      {
                          ...
                          [
                              {
                                  "image": { "content": encodedImage }, "features":[{ "type": "DOCUMENT_TEXT_DETECTION" }]
                              }
                          ]
                      }
                                                              ...
                                                              function (data)
                                                              {
                                                                  ...
                                                                  for (var i = 0; i < allFoods.length; i++)
                                                                  {
                                                                      ...
                                                                      if (receiptDataText.includes(foodName.toUpperCase()))
                                                                      {
                                                                          ...
                                                                          var dm = ((exp.getMonth() + 1) > 9)
                                                                              ? (exp.getMonth() + 1) : "0" + (exp.getMonth() + 1);

                                                                          var dd = (exp.getDate() > 9)
                                                                              ? exp.getDate() : "0" + exp.getDate();
                                                                          ...
                                                                          minDate += (dateInstance.getMonth() + 1) >= 10
                                                                              ? "-" + (dateInstance.getMonth() + 1) : "-0" + (dateInstance.getMonth() + 1);
